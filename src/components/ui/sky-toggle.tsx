...
export const Switch: React.FC<SkyToggleProps> = ({ checked, onChange, className, size = '11px' }) => {
  return (
    <StyledWrapper $toggleSize={size} className={className}>
...
const StyledWrapper = styled.div<{ $toggleSize: string }>`
  ...
  .theme-switch {
    --toggle-size: ${props => props.$toggleSize};
